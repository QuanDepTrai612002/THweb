...
<head>
  <style>
    ...
    object-fit: cover; /* Giữ tỷ lệ khung hình và cắt ảnh để vừa vào khung */
  ...
  <section class="food_section layout_padding-bottom">
    <div class="container">
      ...
      <ul class="filters_menu">
        ...
        <li><a href="index.php?act=banhmi"><b>Bánh mì</b></a></li>
      ...
      foreach ($data as $item) {
        echo '<div class="table-cell">'
          ...
          . $item["product_code"] . '&&pd_n=' . $item["product_name"] . '&&ss_id=' . $_SESSION['id']
          . '" method="post"><button>Thêm</button></form>'
          . '<form action="./viewUser/chitiet.php?pd_c='
          . $item["product_code"] . '&&pd_n=' . $item["product_name"] .  '&&ss_id=' . $_SESSION['id']
          . '" method="post"><button>Chi tiết</button></form>'
          . ' </div>';
      }
      echo '</div>';
      ?>
